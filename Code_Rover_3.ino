...
#define sensor0 A1 //gauche 
#define sensor1 A2 //droite
#define sensor2 A3 //avant
#include <Servo.h>
...
int iRGetRange(void)
{
  ...
  int distanceIR0=13*pow(volts0,-1)*2.54;
  float volts1=analogRead(sensor1)*0.0048828125;
  int distanceIR1=13*pow(volts1,-1)*2.54;
  float volts2=analogRead(sensor2)*0.0048828125;
  int distanceIR2=13*pow(volts2,-1)*2.54;
